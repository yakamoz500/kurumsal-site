  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M9 3v11m0 0l-3 3m3-3l3 3M3 8h6m6 0h6M15 3h6v5h-6z"
      />
    </svg>
  );
}
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-zinc-950/95 backdrop-blur-sm border-b border-zinc-800 py-3"
          : "bg-transparent py-5"
      }`}
    >
          ...
          <a
            ...
            className={`block px-6 py-4 text-xs font-semibold uppercase tracking-widest border-b border-zinc-800/50 transition-colors ${
              active === link.href
                ...
                : "text-gray-300 hover:text-orange-400 hover:bg-zinc-900"
            }`}
          >
            {link.label}
          </a>
